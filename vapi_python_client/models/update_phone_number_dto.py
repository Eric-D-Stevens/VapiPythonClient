...
class UpdatePhoneNumberDTO(object):
    ...
    """
    swagger_types = {
        'fallback_destination': 'OneOfUpdatePhoneNumberDTOFallbackDestination',
        'name': 'str',
        'assistant_id': 'str',
        'squad_id': 'str',
        'server_url': 'str',
    ...
    def __init__(self, fallback_destination=None, name=None, assistant_id=None, squad_id=None, server_url=None, server_url_secret=None):  # noqa: E501
        """UpdatePhoneNumberDTO - a model defined in Swagger"""  # noqa: E501
    ...
    def fallback_destination(self):
        """Gets the fallback_destination of this UpdatePhoneNumberDTO.  # noqa: E501
        ...
        :return: The fallback_destination of this UpdatePhoneNumberDTO.  # noqa: E501
        :rtype: OneOfUpdatePhoneNumberDTOFallbackDestination
        """
        return self._fallback_destination

    @fallback_destination.setter
    def fallback_destination(self, fallback_destination):
        """Sets the fallback_destination of this UpdatePhoneNumberDTO.

        This is the fallback destination an inbound call will be transferred to if: 1. `assistantId` is not set 2. `squadId` is not set 3. and, `assistant-request` message to the `serverUrl` fails  If this is not set and above conditions are met, the inbound call is hung up with an error message.  # noqa: E501

        :param fallback_destination: The fallback_destination of this UpdatePhoneNumberDTO.  # noqa: E501
        :type: OneOfUpdatePhoneNumberDTOFallbackDestination
        """
    ...
    @property
    def name(self):
        """Gets the name of this UpdatePhoneNumberDTO.  # noqa: E501

        This is the name of the phone number. This is just for your own reference.  # noqa: E501

        :return: The name of this UpdatePhoneNumberDTO.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this UpdatePhoneNumberDTO.

        This is the name of the phone number. This is just for your own reference.  # noqa: E501

        :param name: The name of this UpdatePhoneNumberDTO.  # noqa: E501
        :type: str
        """
    ...
    def assistant_id(self):
        """Gets the assistant_id of this UpdatePhoneNumberDTO.  # noqa: E501
        ...
        :return: The assistant_id of this UpdatePhoneNumberDTO.  # noqa: E501
        :rtype: str
        """
    ...
    def assistant_id(self, assistant_id):
        """Sets the assistant_id of this UpdatePhoneNumberDTO.

        This is the assistant that will be used for incoming calls to this phone number.  If neither `assistantId` nor `squadId` is set, `assistant-request` will be sent to your Server URL. Check `ServerMessage` and `ServerMessageResponse` for the shape of the message and response that is expected.  # noqa: E501

        :param assistant_id: The assistant_id of this UpdatePhoneNumberDTO.  # noqa: E501
        :type: str
        """
    ...
    @property
    def squad_id(self):
        """Gets the squad_id of this UpdatePhoneNumberDTO.  # noqa: E501
        ...
        :return: The squad_id of this UpdatePhoneNumberDTO.  # noqa: E501
        :rtype: str
        """
    ...
    def squad_id(self, squad_id):
        """Sets the squad_id of this UpdatePhoneNumberDTO.

        This is the squad that will be used for incoming calls to this phone number.  If neither `assistantId` nor `squadId` is set, `assistant-request` will be sent to your Server URL. Check `ServerMessage` and `ServerMessageResponse` for the shape of the message and response that is expected.  # noqa: E501

        :param squad_id: The squad_id of this UpdatePhoneNumberDTO.  # noqa: E501
        :type: str
        """
    ...
    @property
    def server_url(self):
        """Gets the server_url of this UpdatePhoneNumberDTO.  # noqa: E501
        ...
        :return: The server_url of this UpdatePhoneNumberDTO.  # noqa: E501
        :rtype: str
        """
    ...
    def server_url(self, server_url):
        """Sets the server_url of this UpdatePhoneNumberDTO.

        This is the server URL where messages will be sent for calls on this number. This includes the `assistant-request` message.  You can see the shape of the messages sent in `ServerMessage`.  This overrides the `org.serverUrl`. Order of precedence: tool.server.url > assistant.serverUrl > phoneNumber.serverUrl > org.serverUrl.  # noqa: E501

        :param server_url: The server_url of this UpdatePhoneNumberDTO.  # noqa: E501
        :type: str
        """
    ...
    def server_url_secret(self):
        """Gets the server_url_secret of this UpdatePhoneNumberDTO.  # noqa: E501
        ...
        :return: The server_url_secret of this UpdatePhoneNumberDTO.  # noqa: E501
        :rtype: str
        """
    ...
    def server_url_secret(self, server_url_secret):
        """Sets the server_url_secret of this UpdatePhoneNumberDTO.

        This is the secret Vapi will send with every message to your server. It's sent as a header called x-vapi-secret.  Same precedence logic as serverUrl.  # noqa: E501

        :param server_url_secret: The server_url_secret of this UpdatePhoneNumberDTO.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UpdatePhoneNumberDTO, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdatePhoneNumberDTO):
            return False
