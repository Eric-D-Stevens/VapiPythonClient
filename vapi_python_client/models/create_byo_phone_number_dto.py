...
class CreateByoPhoneNumberDTO(object):
    ...
    def __init__(self, fallback_destination=None, provider=None, number=None, credential_id=None, name=None, assistant_id=None, squad_id=None, server_url=None, server_url_secret=None):  # noqa: E501
        """CreateByoPhoneNumberDTO - a model defined in Swagger"""  # noqa: E501
    ...
    def fallback_destination(self):
        """Gets the fallback_destination of this CreateByoPhoneNumberDTO.  # noqa: E501
        ...
        :return: The fallback_destination of this CreateByoPhoneNumberDTO.  # noqa: E501
        :rtype: OneOfCreateByoPhoneNumberDTOFallbackDestination
        """
        return self._fallback_destination

    @fallback_destination.setter
    def fallback_destination(self, fallback_destination):
        """Sets the fallback_destination of this CreateByoPhoneNumberDTO.

        This is the fallback destination an inbound call will be transferred to if: 1. `assistantId` is not set 2. `squadId` is not set 3. and, `assistant-request` message to the `serverUrl` fails  If this is not set and above conditions are met, the inbound call is hung up with an error message.  # noqa: E501

        :param fallback_destination: The fallback_destination of this CreateByoPhoneNumberDTO.  # noqa: E501
        :type: OneOfCreateByoPhoneNumberDTOFallbackDestination
        """
    ...
    @property
    def provider(self):
        """Gets the provider of this CreateByoPhoneNumberDTO.  # noqa: E501

        This is to bring your own phone numbers from your own SIP trunks or Carriers.  # noqa: E501

        :return: The provider of this CreateByoPhoneNumberDTO.  # noqa: E501
        :rtype: str
        """
    ...
    def provider(self, provider):
        """Sets the provider of this CreateByoPhoneNumberDTO.

        This is to bring your own phone numbers from your own SIP trunks or Carriers.  # noqa: E501

        :param provider: The provider of this CreateByoPhoneNumberDTO.  # noqa: E501
        :type: str
        """
        if provider is None:
    ...
    @property
    def number(self):
        """Gets the number of this CreateByoPhoneNumberDTO.  # noqa: E501
        ...
        :return: The number of this CreateByoPhoneNumberDTO.  # noqa: E501
        :rtype: str
        """
        return self._number
    ...
    def number(self, number):
        """Sets the number of this CreateByoPhoneNumberDTO.

        These are the digits of the phone number you own on your SIP trunk or Carrier.  This is not limited to E164 and can be any alphanumeric string. Example: `+1234567890`, or `abc`, or `1234'.  # noqa: E501

        :param number: The number of this CreateByoPhoneNumberDTO.  # noqa: E501
        :type: str
        """
        if number is None:
    ...
    def credential_id(self):
        """Gets the credential_id of this CreateByoPhoneNumberDTO.  # noqa: E501
        ...
        :return: The credential_id of this CreateByoPhoneNumberDTO.  # noqa: E501
        :rtype: str
        """
    ...
    def credential_id(self, credential_id):
        """Sets the credential_id of this CreateByoPhoneNumberDTO.

        This is the credential of your own SIP trunk or Carrier (type `byo-sip-trunk`) which can be used to make calls to this phone number.  You can add the SIP trunk or Carrier credential in the Provider Credentials page on the Dashboard to get the credentialId.  # noqa: E501

        :param credential_id: The credential_id of this CreateByoPhoneNumberDTO.  # noqa: E501
        :type: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this CreateByoPhoneNumberDTO.  # noqa: E501

        This is the name of the phone number. This is just for your own reference.  # noqa: E501

        :return: The name of this CreateByoPhoneNumberDTO.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this CreateByoPhoneNumberDTO.

        This is the name of the phone number. This is just for your own reference.  # noqa: E501

        :param name: The name of this CreateByoPhoneNumberDTO.  # noqa: E501
        :type: str
        """
    ...
    def assistant_id(self):
        """Gets the assistant_id of this CreateByoPhoneNumberDTO.  # noqa: E501
        ...
        :return: The assistant_id of this CreateByoPhoneNumberDTO.  # noqa: E501
        :rtype: str
        """
    ...
    def assistant_id(self, assistant_id):
        """Sets the assistant_id of this CreateByoPhoneNumberDTO.

        This is the assistant that will be used for incoming calls to this phone number.  If neither `assistantId` nor `squadId` is set, `assistant-request` will be sent to your Server URL. Check `ServerMessage` and `ServerMessageResponse` for the shape of the message and response that is expected.  # noqa: E501

        :param assistant_id: The assistant_id of this CreateByoPhoneNumberDTO.  # noqa: E501
        :type: str
        """
    ...
    @property
    def squad_id(self):
        """Gets the squad_id of this CreateByoPhoneNumberDTO.  # noqa: E501
        ...
        :return: The squad_id of this CreateByoPhoneNumberDTO.  # noqa: E501
        :rtype: str
        """
    ...
    def squad_id(self, squad_id):
        """Sets the squad_id of this CreateByoPhoneNumberDTO.

        This is the squad that will be used for incoming calls to this phone number.  If neither `assistantId` nor `squadId` is set, `assistant-request` will be sent to your Server URL. Check `ServerMessage` and `ServerMessageResponse` for the shape of the message and response that is expected.  # noqa: E501

        :param squad_id: The squad_id of this CreateByoPhoneNumberDTO.  # noqa: E501
        :type: str
        """
    ...
    @property
    def server_url(self):
        """Gets the server_url of this CreateByoPhoneNumberDTO.  # noqa: E501
        ...
        :return: The server_url of this CreateByoPhoneNumberDTO.  # noqa: E501
        :rtype: str
        """
    ...
    def server_url(self, server_url):
        """Sets the server_url of this CreateByoPhoneNumberDTO.

        This is the server URL where messages will be sent for calls on this number. This includes the `assistant-request` message.  You can see the shape of the messages sent in `ServerMessage`.  This overrides the `org.serverUrl`. Order of precedence: tool.server.url > assistant.serverUrl > phoneNumber.serverUrl > org.serverUrl.  # noqa: E501

        :param server_url: The server_url of this CreateByoPhoneNumberDTO.  # noqa: E501
        :type: str
        """
    ...
    def server_url_secret(self):
        """Gets the server_url_secret of this CreateByoPhoneNumberDTO.  # noqa: E501
        ...
        :return: The server_url_secret of this CreateByoPhoneNumberDTO.  # noqa: E501
        :rtype: str
        """
    ...
    def server_url_secret(self, server_url_secret):
        """Sets the server_url_secret of this CreateByoPhoneNumberDTO.

        This is the secret Vapi will send with every message to your server. It's sent as a header called x-vapi-secret.  Same precedence logic as serverUrl.  # noqa: E501

        :param server_url_secret: The server_url_secret of this CreateByoPhoneNumberDTO.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CreateByoPhoneNumberDTO, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateByoPhoneNumberDTO):
            return False
