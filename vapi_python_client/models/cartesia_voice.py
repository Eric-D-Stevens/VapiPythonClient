...
class CartesiaVoice(object):
    ...
    def __init__(self, input_preprocessing_enabled=None, input_reformatting_enabled=None, input_min_characters=None, input_punctuation_boundaries=None, filler_injection_enabled=None, provider=None, model=None, language=None, voice_id=None):  # noqa: E501
        """CartesiaVoice - a model defined in Swagger"""  # noqa: E501
    ...
    def input_preprocessing_enabled(self):
        """Gets the input_preprocessing_enabled of this CartesiaVoice.  # noqa: E501
        ...
        :return: The input_preprocessing_enabled of this CartesiaVoice.  # noqa: E501
        :rtype: bool
        """
    ...
    def input_preprocessing_enabled(self, input_preprocessing_enabled):
        """Sets the input_preprocessing_enabled of this CartesiaVoice.

        This determines whether the model output is preprocessed into chunks before being sent to the voice provider.  Default `true` because voice generation sounds better with chunking (and reformatting them).  To send every token from the model output directly to the voice provider and rely on the voice provider's audio generation logic, set this to `false`.  If disabled, vapi-provided audio control tokens like <flush /> will not work.  # noqa: E501

        :param input_preprocessing_enabled: The input_preprocessing_enabled of this CartesiaVoice.  # noqa: E501
        :type: bool
        """
    ...
    def input_reformatting_enabled(self):
        """Gets the input_reformatting_enabled of this CartesiaVoice.  # noqa: E501
        ...
        :return: The input_reformatting_enabled of this CartesiaVoice.  # noqa: E501
        :rtype: bool
        """
    ...
    def input_reformatting_enabled(self, input_reformatting_enabled):
        """Sets the input_reformatting_enabled of this CartesiaVoice.

        This determines whether the chunk is reformatted before being sent to the voice provider. Many things are reformatted including phone numbers, emails and addresses to improve their enunciation.  Default `true` because voice generation sounds better with reformatting.  To disable chunk reformatting, set this to `false`.  To disable chunking completely, set `inputPreprocessingEnabled` to `false`.  # noqa: E501

        :param input_reformatting_enabled: The input_reformatting_enabled of this CartesiaVoice.  # noqa: E501
        :type: bool
        """
    ...
    def input_min_characters(self):
        """Gets the input_min_characters of this CartesiaVoice.  # noqa: E501
        ...
        :return: The input_min_characters of this CartesiaVoice.  # noqa: E501
        :rtype: float
        """
    ...
    def input_min_characters(self, input_min_characters):
        """Sets the input_min_characters of this CartesiaVoice.

        This is the minimum number of characters before a chunk is created. The chunks that are sent to the voice provider for the voice generation as the model tokens are streaming in. Defaults to 30.  Increasing this value might add latency as it waits for the model to output a full chunk before sending it to the voice provider. On the other hand, increasing might be a good idea if you want to give voice provider bigger chunks so it can pronounce them better.  Decreasing this value might decrease latency but might also decrease quality if the voice provider struggles to pronounce the text correctly.  # noqa: E501

        :param input_min_characters: The input_min_characters of this CartesiaVoice.  # noqa: E501
        :type: float
        """
    ...
    def input_punctuation_boundaries(self):
        """Gets the input_punctuation_boundaries of this CartesiaVoice.  # noqa: E501
        ...
        :return: The input_punctuation_boundaries of this CartesiaVoice.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def input_punctuation_boundaries(self, input_punctuation_boundaries):
        """Sets the input_punctuation_boundaries of this CartesiaVoice.

        These are the punctuations that are considered valid boundaries before a chunk is created. The chunks that are sent to the voice provider for the voice generation as the model tokens are streaming in. Defaults are chosen differently for each provider.  Constraining the delimiters might add latency as it waits for the model to output a full chunk before sending it to the voice provider. On the other hand, constraining might be a good idea if you want to give voice provider longer chunks so it can sound less disjointed across chunks. Eg. ['.'].  # noqa: E501

        :param input_punctuation_boundaries: The input_punctuation_boundaries of this CartesiaVoice.  # noqa: E501
        :type: list[str]
        """
    ...
    def filler_injection_enabled(self):
        """Gets the filler_injection_enabled of this CartesiaVoice.  # noqa: E501
        ...
        :return: The filler_injection_enabled of this CartesiaVoice.  # noqa: E501
        :rtype: bool
        """
    ...
    def filler_injection_enabled(self, filler_injection_enabled):
        """Sets the filler_injection_enabled of this CartesiaVoice.

        This determines whether fillers are injected into the model output before inputting it into the voice provider.  Default `false` because you can achieve better results with prompting the model.  # noqa: E501

        :param filler_injection_enabled: The filler_injection_enabled of this CartesiaVoice.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def provider(self):
        """Gets the provider of this CartesiaVoice.  # noqa: E501

        This is the voice provider that will be used.  # noqa: E501

        :return: The provider of this CartesiaVoice.  # noqa: E501
        :rtype: str
        """
    ...
    def provider(self, provider):
        """Sets the provider of this CartesiaVoice.

        This is the voice provider that will be used.  # noqa: E501

        :param provider: The provider of this CartesiaVoice.  # noqa: E501
        :type: str
        """
        if provider is None:
            raise ValueError("Invalid value for `provider`, must not be `None`")  # noqa: E501
        allowed_values = ["cartesia"]  # noqa: E501
    ...
    @property
    def model(self):
        """Gets the model of this CartesiaVoice.  # noqa: E501

        This is the model that will be used. This is optional and will default to the correct model for the voiceId.  # noqa: E501

        :return: The model of this CartesiaVoice.  # noqa: E501
        :rtype: str
        """
        return self._model
    ...
    def model(self, model):
        """Sets the model of this CartesiaVoice.

        This is the model that will be used. This is optional and will default to the correct model for the voiceId.  # noqa: E501

        :param model: The model of this CartesiaVoice.  # noqa: E501
        :type: str
        """
        allowed_values = ["sonic-english", "sonic-multilingual"]  # noqa: E501
    ...
    @property
    def language(self):
        """Gets the language of this CartesiaVoice.  # noqa: E501

        This is the language that will be used. This is optional and will default to the correct language for the voiceId.  # noqa: E501

        :return: The language of this CartesiaVoice.  # noqa: E501
        :rtype: str
        """
    ...
    def language(self, language):
        """Sets the language of this CartesiaVoice.

        This is the language that will be used. This is optional and will default to the correct language for the voiceId.  # noqa: E501

        :param language: The language of this CartesiaVoice.  # noqa: E501
        :type: str
        """
        allowed_values = ["de", "en", "es", "fr", "ja", "pt", "zh"]  # noqa: E501
    ...
    @property
    def voice_id(self):
        """Gets the voice_id of this CartesiaVoice.  # noqa: E501

        This is the provider-specific ID that will be used.  # noqa: E501

        :return: The voice_id of this CartesiaVoice.  # noqa: E501
        :rtype: str
        """
    ...
    def voice_id(self, voice_id):
        """Sets the voice_id of this CartesiaVoice.

        This is the provider-specific ID that will be used.  # noqa: E501

        :param voice_id: The voice_id of this CartesiaVoice.  # noqa: E501
        :type: str
        """
        if voice_id is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CartesiaVoice, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CartesiaVoice):
            return False
