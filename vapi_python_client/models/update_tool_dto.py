...
class UpdateToolDTO(object):
    ...
    swagger_types = {
        '_async': 'bool',
        'messages': 'list[OneOfUpdateToolDTOMessagesItems]',
        'function': 'AllOfUpdateToolDTOFunction',
        'server': 'AllOfUpdateToolDTOServer'
    }
    ...
    def __init__(self, _async=None, messages=None, function=None, server=None):  # noqa: E501
        """UpdateToolDTO - a model defined in Swagger"""  # noqa: E501
        self.__async = None
        self._messages = None
        self._function = None
        self._server = None
    ...
    @property
    def _async(self):
        """Gets the _async of this UpdateToolDTO.  # noqa: E501
        ...
        :return: The _async of this UpdateToolDTO.  # noqa: E501
        :rtype: bool
        """
        return self.__async
    ...
    def _async(self, _async):
        """Sets the _async of this UpdateToolDTO.

        This determines if the tool is async.  If async, the assistant will move forward without waiting for your server to respond. This is useful if you just want to trigger something on your server.  If sync, the assistant will wait for your server to respond. This is useful if want assistant to respond with the result from your server.  Defaults to synchronous (`false`).  # noqa: E501

        :param _async: The _async of this UpdateToolDTO.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def messages(self):
        """Gets the messages of this UpdateToolDTO.  # noqa: E501
        ...
        :return: The messages of this UpdateToolDTO.  # noqa: E501
        :rtype: list[OneOfUpdateToolDTOMessagesItems]
        """
        return self._messages

    @messages.setter
    def messages(self, messages):
        """Sets the messages of this UpdateToolDTO.

        These are the messages that will be spoken to the user as the tool is running.  For some tools, this is auto-filled based on special fields like `tool.destinations`. For others like the function tool, these can be custom configured.  # noqa: E501

        :param messages: The messages of this UpdateToolDTO.  # noqa: E501
        :type: list[OneOfUpdateToolDTOMessagesItems]
        """
    ...
    @property
    def function(self):
        """Gets the function of this UpdateToolDTO.  # noqa: E501
        ...
        :return: The function of this UpdateToolDTO.  # noqa: E501
        :rtype: AllOfUpdateToolDTOFunction
        """
        return self._function

    @function.setter
    def function(self, function):
        """Sets the function of this UpdateToolDTO.

        This is the function definition of the tool.  For `endCall`, `transferCall`, and `dtmf` tools, this is auto-filled based on tool-specific fields like `tool.destinations`. But, even in those cases, you can provide a custom function definition for advanced use cases.  An example of an advanced use case is if you want to customize the message that's spoken for `endCall` tool. You can specify a function where it returns an argument \"reason\". Then, in `messages` array, you can have many \"request-complete\" messages. One of these messages will be triggered if the `messages[].conditions` matches the \"reason\" argument.  # noqa: E501

        :param function: The function of this UpdateToolDTO.  # noqa: E501
        :type: AllOfUpdateToolDTOFunction
        """
    ...
    @property
    def server(self):
        """Gets the server of this UpdateToolDTO.  # noqa: E501
        ...
        :return: The server of this UpdateToolDTO.  # noqa: E501
        :rtype: AllOfUpdateToolDTOServer
        """
        return self._server

    @server.setter
    def server(self, server):
        """Sets the server of this UpdateToolDTO.

        This is the server that will be hit when this tool is requested by the model.  All requests will be sent with the call object among other things. You can find more details in the Server URL documentation.  This overrides the serverUrl set on the org and the phoneNumber. Order of precedence: highest tool.server.url, then assistant.serverUrl, then phoneNumber.serverUrl, then org.serverUrl.  # noqa: E501

        :param server: The server of this UpdateToolDTO.  # noqa: E501
        :type: AllOfUpdateToolDTOServer
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UpdateToolDTO, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateToolDTO):
            return False
