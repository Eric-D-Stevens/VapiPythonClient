...
**tools** | **list[OneOfGroqModelToolsItems]** | These are the tools that the assistant can use during the call. To use existing tools, use &#x60;toolIds&#x60;.  Both &#x60;tools&#x60; and &#x60;toolIds&#x60; can be used together. | [optional] 
...
**knowledge_base** | **AllOfGroqModelKnowledgeBase** | These are the options for the knowledge base. | [optional] 
