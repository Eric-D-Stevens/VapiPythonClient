...
**voice_id** | **OneOfElevenLabsVoiceVoiceId** | This is the provider-specific ID that will be used. Ensure the Voice is present in your 11Labs Voice Library. | 
**stability** | **float** | Defines the stability for voice settings. | [optional] 
**similarity_boost** | **float** | Defines the similarity boost for voice settings. | [optional] 
**style** | **float** | Defines the style for voice settings. | [optional] 
**use_speaker_boost** | **bool** | Defines the use speaker boost for voice settings. | [optional] 
**optimize_streaming_latency** | **float** | Defines the optimize streaming latency for voice settings. Defaults to 3. | [optional] 
**enable_ssml_parsing** | **bool** | Defines the use of https://elevenlabs.io/docs/speech-synthesis/prompting#pronunciation. Disabled by default. | [optional] 
**model** | **str** | This is the model that will be used. Defaults to &#x27;eleven_turbo_v2&#x27; if not specified. | [optional] 
